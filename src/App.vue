...
<template>
    <div class="w-screen h-screen flex flex-col py-4">
        ...
        >
            ...
            <div
                class="h-full overflow-y-scroll w-full scrollbar-none bg-gray-100"
            >
                <div
                ...
                >
                    <div class="absolute position-center text-gray-300">
                        <div
                            class="flex flex-col items-center text-center w-72"
                        >
                            <i class="fas fa-list-ul fa-4x"></i>
                            <span class="font-bold">List not selected</span>
                            <p class="text-sm">
                                Select a list from the left to view and work on
                                your todos
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div class="flex flex-row w-full">
                            <div
                                ...
                                :class="
                                    todo.completed ? 'bg-green-400' : 'border'
                                "
                                @click="
                                    vm.upsertNewTodo({
                                        ...todo,
